...
export default function CartPage() {
  ...
  const handleIncrement = (ticketId: number) => {
    ...
    if (currentTicket) {
      handleQuantityChange(ticketId, currentTicket.quantity + 1);
    }
  };
      ...
      <div className={styles.mainContent}>
        ...
        <div className={styles.contentGrid}>
          ...
          <div className={styles.leftColumn}>
            <div className={styles.sectionHeader}>Escoge tus entradas</div>

            <div className={styles.ticketSelectionCard}>
              <div className={styles.dateHeader}>20/05/2025</div>

              <div className={styles.tableHeader}>
                <div className={styles.tableHeaderItem}>ENTRADA</div>
                <div className={styles.tableHeaderItem}>PRECIO</div>
                <div className={styles.tableHeaderItem}>CANTIDAD</div>
              </div>
          ...
          <div className={styles.rightColumn}>
            <div className={styles.sectionHeader}>Carrito de compra</div>

            <div className={styles.cartCard}>
              <div className={styles.cartHeader}>Entrada General</div>

              {cartItems.length > 0 ? (
                <>
                  {cartItems.map((item) => (
                    <div key={item.id} className={styles.cartItem}>
                      <div className={styles.cartItemIndicator} />
